package com.rivermeadow.scheduler.validation;
...
/**
 * See {@link com.rivermeadow.scheduler.validation.Schedule}. Validates the 'schedule' field is either
 * the value 'now' or an ISO8601 datetime string.
 */
